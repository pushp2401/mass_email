...
import re 
import time
# yag = yagmail.SMTP('pushpanjaliaero2401', 'dqvx qlfv mfgz mmwk') 
# yag = yagmail.SMTP('soonju.jeong', 'dqvx qlfv mfgz mmwk') 

sender_email = "soonju.jeong@doaz.ai"
app_password = "fizk ccmm iyqh joep" #soonju
